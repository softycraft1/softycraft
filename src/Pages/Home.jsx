        ...
        <div className="h-auto py-4">
          <div className="text-center my-10">
            ...
            <p className="text-justify tracking-normal text-black font-semibold leading-7 m-12">
              ...
              please don't hesitate to meet our team.
            </p>
          </div>
          <div className="m-12">
            <div>
              <div className="grid gap-7 grid-cols-3">
                {services.map((data) => (
                  <div
                    className="text-center  bg-[#ccc] hover:bg-[#D61E30]"
                    key={data.id}
                  >
                    <div className="m-4">
                      <img
                      ...
                      <button
                        className="btn btn-active my-6 btn-primary"
                        href={data.link}
                      >
                        Read More........
                      </button>
                ...
                {projects.map((project) => (
                  ...
                  >
                    <div className="m-4">
                      ...
                      <div className="divider divider-success p-2 m-2"></div>
                      <p className="text-justify">{project.project_type}</p>
                      <button
                        className="btn btn-active my-6 btn-primary"
